...
// (DO NOT EDIT: machine generated header) 'uTPLb_RSA_Engine.pas' rev: 31.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define RSAKeySig u"N\nLockBox3"
static constexpr System::Int8 RSAKeyStoreVersion = System::Int8(0x1);
}	/* namespace Utplb_rsa_engine */
