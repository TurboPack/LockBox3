...
// (DO NOT EDIT: machine generated header) 'uTPLb_Codec.pas' rev: 30.00 (Android)
...
public:
	...
	void __fastcall EncryptMemory(const System::TArray__1<System::Byte> Plaintext, int PlaintextLen);
