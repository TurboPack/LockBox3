...
// (DO NOT EDIT: machine generated header) 'LockBox3VCLDD.dpk' rev: 31.00 (Windows)
...
namespace Lockbox3vcldd
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Lockbox3vcldd */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LOCKBOX3VCLDD)
using namespace Lockbox3vcldd;
#endif
#pragma pack(pop)
#pragma option pop
