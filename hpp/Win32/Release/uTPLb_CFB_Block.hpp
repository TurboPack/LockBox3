...
// (DO NOT EDIT: machine generated header) 'uTPLb_CFB_Block.pas' rev: 33.00 (Windows)
...
public:
	/* TObject.Create */ inline __fastcall TCFB_Block() : System::TInterfacedObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TCFB_Block() { }
...
public:
	/* TBlockChainLink.Destroy */ inline __fastcall virtual ~TCFB_BlockLink() { }
	
public:
	/* TObject.Create */ inline __fastcall TCFB_BlockLink() : Utplb_blockcipher::TBlockChainLink() { }
