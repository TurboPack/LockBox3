...
// (DO NOT EDIT: machine generated header) 'uTPLb_CodecIntf.pas' rev: 33.00 (Windows)
...
__interface DELPHIINTERFACE ICodec;
...
__interface  INTERFACE_UUID("{48B3116A-5681-4E79-9013-8EC89BAC5B35}") ICodec  : public System::IInterface 
{
	...
	virtual TCodecMode __fastcall GetMode() = 0 ;
	virtual Utplb_streamcipher::_di_IStreamCipher __fastcall GetStreamCipher() = 0 ;
	virtual Utplb_blockcipher::_di_IBlockCipher __fastcall GetBlockCipher() = 0 ;
	virtual Utplb_blockcipher::_di_IBlockChainingModel __fastcall GetChainMode() = 0 ;
	virtual TOnEncDecProgress __fastcall GetOnProgress() = 0 ;
	virtual void __fastcall SetOnProgress(TOnEncDecProgress Value) = 0 ;
	virtual unsigned __fastcall GetAsymetricKeySizeInBits() = 0 ;
	virtual void __fastcall SetAsymetricKeySizeInBits(unsigned value) = 0 ;
	virtual TGenerateAsymetricKeyPairProgress __fastcall GetAsymGenProgressEvent() = 0 ;
	virtual void __fastcall SetAsymGenProgressEvent(TGenerateAsymetricKeyPairProgress Value) = 0 ;
	virtual Utplb_streamcipher::TSymetricKey* __fastcall GetKey() = 0 ;
	...
	virtual bool __fastcall isAsymetric() = 0 ;
	virtual void __fastcall InitFromGeneratedAsymetricKeyPair() = 0 ;
	...
	virtual void __fastcall EncryptMemory(const System::DynamicArray<System::Byte> Plaintext, int PlaintextLen) = 0 ;
	virtual void __fastcall End_EncryptMemory() = 0 ;
	...
	virtual void __fastcall End_DecryptMemory() = 0 ;
	...
	virtual bool __fastcall GetAborted() = 0 ;
	virtual void __fastcall SetAborted(bool Value) = 0 ;
	virtual Utplb_blockcipher::TSymetricEncryptionOptionSet __fastcall GetAdvancedOptions2() = 0 ;
	virtual void __fastcall SetAdvancedOptions2(Utplb_blockcipher::TSymetricEncryptionOptionSet Value) = 0 ;
	virtual Utplb_blockcipher::TSetMemStreamProc __fastcall GetOnSetIV() = 0 ;
