...
// (DO NOT EDIT: machine generated header) 'uTPLb_OFB.pas' rev: 33.00 (Windows)
...
public:
	/* TObject.Create */ inline __fastcall TOFB() : System::TInterfacedObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TOFB() { }
...
public:
	/* TBlockChainLink.Destroy */ inline __fastcall virtual ~TOFBLink() { }
	
public:
	/* TObject.Create */ inline __fastcall TOFBLink() : Utplb_blockcipher::TBlockChainLink() { }
